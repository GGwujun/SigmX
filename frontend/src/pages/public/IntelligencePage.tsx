...
interface Feed { articles: Article[]; query: string; sources: string[]; updated_at: string; cache_status: "live" | "fresh_cache" | "stale_cache"; cached_until: string | null }
