...
from src.api.admin_ai_routes import register_admin_ai_routes  # noqa: E402
register_admin_ai_routes(app)
...
def serve_main(argv: list[str] | None = None) -> int:
    ...
    if args.dev and frontend_root.exists():
        ...
        # Check if root route already exists (skip _IncludedRouter objects without .path)
        has_root_route = any(
